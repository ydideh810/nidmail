            ...
            <div className="custom-screen">
                <div className="mt-10 py-8 border-t border-gray-800 items-center justify-between sm:flex">
                    ...
                    <div className="flex items-center justify-center gap-x-6 text-gray-500 mt-6 sm:mt-0">
                        <a href="https://x.com/niddam_ai" target="_blank" aria-label="social media">
                        ...
                        <a href="https://www.linkedin.com/in/yonis-dideh-33a904181/" target="_blank" aria-label="social media">
                        ...
                        <a href="https://www.producthunt.com/posts/niddam?embed=true&utm_source=badge-featured&utm_medium=badge&utm_souce=badge-niddam" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=466294&theme=light" alt="Niddam - Your&#0032;Ultimate&#0032;Private&#0032;Assistant | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
                    </div>
                </div>
            </div>
        </footer>
