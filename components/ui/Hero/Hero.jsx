...
import HeroImg from "@/public/images/table.png"
...
const Hero = () => (
    <section>
                ...
                <div>
                    <div className="space-y-5 max-w-3xl mx-auto text-center">
                        ...
                        <div className="flex justify-center font-medium text-sm">
                            <NavLink
                                href="/#pricing"
                                className="flex items-center text-white bg-red-600 hover:bg-red-500 active:bg-red-700 "
                            >
                                Get Started
      ...
      <Image className="shadow-lg rounded-2xl" src={HeroImg} style={{ alignSelf: 'center', display: 'flex', justifyContent: 'center' }} alt="Niddam" />
